...
export type ResolvedError<T> = T extends EvalErrorConstructor | EvalError
  ? EvalError
  : T extends RangeErrorConstructor | RangeError
  ? RangeError
  : T extends ReferenceErrorConstructor | ReferenceError
  ? ReferenceError
  : T extends SyntaxErrorConstructor | SyntaxError
  ? SyntaxError
  : T extends TypeErrorConstructor | TypeError
  ? TypeError
  : T extends URIErrorConstructor | URIError
  ? URIError
  : never

export type Resolved<T> = T extends RegExp
  ? RegExpExecArray
  ...
  : T extends Error
  ? ResolvedError<T>
  : T extends Promise<infer U> | PromiseConstructor
  ? Promise<Resolved<U>>
  ...
  : T extends AnyValue
  ? unknown
  : T extends TypedValue<infer U>
  ? Resolved<U>
  : T extends NullableValue<infer U>
  ? Resolved<U> | null
  : T extends OptionalValue<infer U>
  ? Resolved<U> | undefined
